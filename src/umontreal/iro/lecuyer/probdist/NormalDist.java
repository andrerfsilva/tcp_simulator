 ...
 * distribution (e.g.,). It has mean <SPAN CLASS="MATH"><I>&#956;</I></SPAN> and
 * variance <SPAN CLASS="MATH"><I>&#963;</I><SUP>2</SUP></SPAN>. Its density
 * function is
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>f</I> (<I>x</I>) =
 * <I>e</I><SUP>-(
 * x-<I>&#956;</I>)<SUP>2</SUP>/(2<I>&#963;</I><SUP>2</SUP>)</SUP>
 * /((2&pi;)<SUP>1
 * /2</SUP><I>&#963;</I>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for -
 * &#8734; &lt; <I>x</I> &lt; &#8734;, </DIV>
 * <P>
 * </P>
 * where <SPAN CLASS="MATH"><I>&#963;</I> &gt; 0</SPAN>. When <SPAN
 * CLASS="MATH"><I>&#956;</I> = 0</SPAN> and <SPAN CLASS="MATH"><I>&#963;</I> =
 * 1</SPAN>, we have the <EM>standard normal</EM> distribution, with
 ...
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>F</I>(<I>x</I>) =
 * <I>&#934;</I>(<I>x</I>) =
 * &int;<SUB>-&#8734;</SUB><SUP>x</SUP><I>e</I><SUP>-t<
 * SUP>2</SUP>/2</SUP>&nbsp;<
 * I>dt</I>/(2&pi;)<SUP>1/2</SUP>&nbsp;&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp;&nbsp;for - &#8734; &lt; <I>x</I> &lt; &#8734;. </DIV>
 * <P>
 * </P>
 * The non-static methods <TT>cdf</TT>, <TT>barF</TT>, and <TT>inverseF</TT> are
 * implemented via {@link #cdf01 cdf01}, {@link #barF01 barF01}, and
 * {@link #inverseF01 inverseF01}, respectively.
 * 
 */
public class NormalDist extends ContinuousDistribution {
	...
	private static final double[] AbarF = { 6.10143081923200418E-1,
			-4.34841272712577472E-1, 1.76351193643605501E-1,
			-6.07107956092494149E-2, 1.77120689956941145E-2,
			-4.32111938556729382E-3, 8.54216676887098679E-4,
			-1.27155090609162743E-4, 1.12481672436711895E-5,
			3.13063885421820973E-7, -2.70988068537762022E-7,
			3.07376227014076884E-8, 2.51562038481762294E-9,
			-1.02892992132031913E-9, 2.99440521199499394E-11,
			2.60517896872669363E-11, -2.63483992417196939E-12,
	...
	/**
	 * Constructs a <TT>NormalDist</TT> object with default parameters <SPAN
	 * CLASS="MATH"><I>&#956;</I> = 0</SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I> = 1</SPAN>.
	 * 
	 */
	public NormalDist() {
		setParams(0.0, 1.0);
	...
	/**
	 * Constructs a <TT>NormalDist</TT> object with mean <SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN> = <TT>mu</TT> and standard deviation
	 * <SPAN CLASS="MATH"><I>&#963;</I></SPAN> = <TT>sigma</TT>.
	 * 
	 */
	...
	/**
	 * Same as {@link #density(double,double,double) density}&nbsp;
	 * <TT>(0, 1, x)</TT>.
	 * 
	 */
	...
	private static final double NORMAL2_A[] = {
			...
			2.6051789687266936290e-11, -2.634839924171969386e-12,
			-6.43404509890636443e-13, 1.12457401801663447e-13,
	...
	/*
	 * , 2.14977356470e-19, 4.6660985008e-20, -7.243011862e-21,
	 * -2.387966824e-21, 1.91177535e-22, 1.20482568e-22, -6.72377e-25,
	 * -5.747997e-24, -4.28493e-25, 2.44856e-25, 4.3793e-26, -8.151e-27,
	 * -3.089e-27, 9.3e-29, 1.74e-28, 1.6e-29, -8.0e-30, -2.0e-30
	 */
	};
	...
	public static double cdf01(double x) {
		/*
		 * Returns P[X < x] for the normal distribution. As in J. L.
		 * Schonfelder, Math. of Computation, Vol. 32, pp 1232--1240, (1978).
		 */
		...
		if (x < 0) {
			x = -x;
			t = (x - 3.75) / (x + 3.75);
			r = 1.0 - 0.5 * Math.exp(-x * x)
					* Num.evalCheby(NORMAL2_A, COEFFMAX, t);
		} else {
			t = (x - 3.75) / (x + 3.75);
	...
	/**
	 * Computes the normal distribution function with mean <SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN> and variance <SPAN
	 * CLASS="MATH"><I>&#963;</I><SUP>2</SUP></SPAN>. Uses the Chebyshev
	 * approximation , which gives 16 decimals of precision.
	 * 
	 */
	...
	/**
	 * Same as {@link #barF(double,double,double) barF}&nbsp;<TT>(0, 1, x)</TT>.
	 * 
	 */
	 ...
	 * 
	 * <SPAN CLASS="MATH">bar(F)(<I>x</I>) = 1 - <I>&#934;</I>((<I>x</I> -
	 * <I>&#956;</I>)/<I>&#963;</I>)</SPAN>, with mean <SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN> and variance <SPAN
	 * CLASS="MATH"><I>&#963;</I><SUP>2</SUP></SPAN>. Uses a Chebyshev series
	...
	private static final double[] InvP1 = { 0.160304955844066229311E2,
			-0.90784959262960326650E2, 0.18644914861620987391E3,
			-0.16900142734642382420E3, 0.6545466284794487048E2,
			-0.864213011587247794E1, 0.1760587821390590 };

	private static final double[] InvQ1 = { 0.147806470715138316110E2,
			-0.91374167024260313396E2, 0.21015790486205317714E3,
			-0.22210254121855132366E3, 0.10760453916055123830E3,
			-0.206010730328265443E2, 0.1E1 };

	private static final double[] InvP2 = { -0.152389263440726128E-1,
			0.3444556924136125216, -0.29344398672542478687E1,
			0.11763505705217827302E2, -0.22655292823101104193E2,
			0.19121334396580330163E2, -0.5478927619598318769E1,
			0.237516689024448000 };

	private static final double[] InvQ2 = { -0.108465169602059954E-1,
			0.2610628885843078511, -0.24068318104393757995E1,
			0.10695129973387014469E2, -0.23716715521596581025E2,
			0.24640158943917284883E2, -0.10014376349783070835E2, 0.1E1 };

	private static final double[] InvP3 = { 0.56451977709864482298E-4,
			0.53504147487893013765E-2, 0.12969550099727352403,
			0.10426158549298266122E1, 0.28302677901754489974E1,
			0.26255672879448072726E1, 0.20789742630174917228E1,
			0.72718806231556811306, 0.66816807711804989575E-1,
			-0.17791004575111759979E-1, 0.22419563223346345828E-2 };

	private static final double[] InvQ3 = { 0.56451699862760651514E-4,
			0.53505587067930653953E-2, 0.12986615416911646934,
			0.10542932232626491195E1, 0.30379331173522206237E1,
			0.37631168536405028901E1, 0.38782858277042011263E1,
			0.20372431817412177929E1, 0.1E1 };

	/**
	 * Same as {@link #inverseF(double,double,double) inverseF}&nbsp;
	 * <TT>(0, 1, u)</TT>.
	 * 
	 */
	public static double inverseF01(double u) {
		 ...
		 * approximations giving 16 decimals of precision. J.M. Blair, C.A.
		 * Edwards, J.H. Johnson, "Rational Chebyshev approximations for the
		 * Inverse of the Error Function", in Mathematics of Computation, Vol.
		 * 30, 136, pp 827, (1976)
		 */
	...
	/**
	 * Estimates the parameters <SPAN CLASS="MATH">(<I>&#956;</I>,
	 * <I>&#963;</I>)</SPAN> of the normal distribution using the maximum
	 * likelihood method, from the <SPAN CLASS="MATH"><I>n</I></SPAN>
	 * observations <SPAN CLASS="MATH"><I>x</I>[<I>i</I>]</SPAN>, <SPAN
	 * CLASS="MATH"><I>i</I> = 0, 1,&#8230;, <I>n</I> - 1</SPAN>. The estimates
	 * are returned in a two-element array, in regular order: [<SPAN
	 * CLASS="MATH">hat(&mu;)</SPAN>, <SPAN CLASS="MATH">hat(&sigma;)</SPAN>].
	 * 
	 * @param x
	...
	/**
	 * Creates a new instance of a normal distribution with parameters <SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN> estimated using the maximum likelihood
	 * method based on the <SPAN CLASS="MATH"><I>n</I></SPAN> observations <SPAN
	 * CLASS="MATH"><I>x</I>[<I>i</I>]</SPAN>, <SPAN CLASS="MATH"><I>i</I> = 0,
	 * 1,&#8230;, <I>n</I> - 1</SPAN>.
	 * 
	 * @param x
	 ...
	 * <I>&#956;</I></SPAN> of the normal distribution with parameters <SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN>.
	 * 
	 * @return the mean of the normal distribution <SPAN
	 *         CLASS="MATH"><I>E</I>[<I>X</I>] = <I>&#956;</I></SPAN>
	 * 
	 */
	 ...
	 * <I>&#963;</I><SUP>2</SUP></SPAN> of the normal distribution with
	 * parameters <SPAN CLASS="MATH"><I>&#956;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN>.
	 * 
	 * @return the variance of the normal distribution <SPAN
	 *         CLASS="MATH">Var[<I>X</I>] = <I>&#963;</I><SUP>2</SUP></SPAN>
	 * 
	 */
	...
	/**
	 * Computes and returns the standard deviation <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN> of the normal distribution with
	 * parameters <SPAN CLASS="MATH"><I>&#956;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN>.
	 * 
	...
	/**
	 * Sets the parameters <SPAN CLASS="MATH"><I>&#956;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN> of this object.
	 * 
	 */
	 ...
	 * This table is put in regular order: [<SPAN
	 * CLASS="MATH"><I>&#956;</I></SPAN>, <SPAN
	 * CLASS="MATH"><I>&#963;</I></SPAN>].
	 * 
	 * 
	 */
	...
	public String toString() {
		return getClass().getSimpleName() + " : mu = " + mu + ", sigma = "
				+ sigma;
	}
